...
int native_expression_tree(unsigned char *const in1, unsigned char *const out) {
...
{  // compute scope
auto Image_1 = visioncpp::terminal<visioncpp::pixel::U8C3, 512, 512, visioncpp::memory_type::Buffer2D>(in1);
